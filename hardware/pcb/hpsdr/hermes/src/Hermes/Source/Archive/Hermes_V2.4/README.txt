7 May 2013 Joe Martin K5SO

Changes in this firmware version relative to Hermes_v2.3:

- fixed Alex 6m preamp switching bug,

- reduced the Alex SPI bus speed by half to permit longer ribbon cable connections to Alex,
 
- assigned unused Rx freqs to the Tx freq, thereby improving Alex switching reliability when selecting HPF/LPF filters,
