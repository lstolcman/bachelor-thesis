...
# ACDS 15.1 185 win32 2016.04.22.13:59:11
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/cic_cic_ii_0.vo" -work cic_ii_0 -cdslib ./cds_libs/cic_ii_0.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/cic.v"                                                                        
fi
