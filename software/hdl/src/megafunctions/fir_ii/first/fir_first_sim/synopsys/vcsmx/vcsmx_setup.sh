...
# ACDS 15.1 185 win32 2016.04.14.09:16:36
...
# # End of template
# ----------------------------------------
# If fir_first is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_first_rtl.vhd"                              
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_first_ast.vhd"                              
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_first.vhd"                                  
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_first_tb.vhd"                               
fi
