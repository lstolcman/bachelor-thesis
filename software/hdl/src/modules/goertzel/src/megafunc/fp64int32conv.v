...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=64 WIDTH_EXP_INPUT=11 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=52 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 aclr clock dataa result
...
module  fp64int32conv_altbarrel_shift_50g
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp64int32conv_altbarrel_shift_50g

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 402 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp64int32conv_altfp_convert_8hn
	( 
	aclr,
	clock,
	dataa,
...
`endif
	...
	fp64int32conv_altbarrel_shift_50g   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //fp64int32conv_altfp_convert_8hn
//VALID FILE
...
module fp64int32conv (
	...
	fp64int32conv_altfp_convert_8hn	fp64int32conv_altfp_convert_8hn_component (
				.aclr (aclr),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
