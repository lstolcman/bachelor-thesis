...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=64 WIDTH_EXP_INPUT=11 WIDTH_EXP_OUTPUT=8 WIDTH_INT=64 WIDTH_MAN_INPUT=52 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=64 aclr clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=115 WIDTHDIST=7 aclr clk_en clock data distance result
...
module  fp64int64conv_altbarrel_shift_h1g
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp64int64conv_altbarrel_shift_h1g

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 530 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp64int64conv_altfp_convert_ihn
	( 
	aclr,
	clock,
	dataa,
...
`endif
	...
	wire  [114:0]   wire_altbarrel_shift6_result;
	...
	wire  [62:0]   wire_add_sub7_result;
	wire  wire_add_sub8_cout;
	wire  [30:0]   wire_add_sub8_result;
	wire  [31:0]   wire_add_sub9_result;
	wire  wire_cmpr1_aeb;
	wire  wire_cmpr1_agb;
	wire  wire_cmpr2_aeb;
	wire  wire_cmpr3_alb;
	...
	fp64int64conv_altbarrel_shift_h1g   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	assign
		...
		clk_en = 1'b1,
		const_bias_value_add_width_res_w = 11'b10000111110,
		...
		inv_add_1_adder2_w = (({32{(~ wire_add_sub8_cout)}} & inv_integer[62:31]) | ({32{wire_add_sub8_cout}} & wire_add_sub9_result)),
...
endmodule //fp64int64conv_altfp_convert_ihn
//VALID FILE
...
module fp64int64conv (
	...
	fp64int64conv_altfp_convert_ihn	fp64int64conv_altfp_convert_ihn_component (
				.aclr (aclr),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
