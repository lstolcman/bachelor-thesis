...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV E" EXCEPTION_HANDLING="NO" PIPELINE=5 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=11 WIDTH_MAN=52 aclr clock dataa datab result
...
endmodule //fpmult_altfp_mult_bbo
//VALID FILE
...
module fpmult (
	...
	fpmult_altfp_mult_bbo	fpmult_altfp_mult_bbo_component (
				.aclr (aclr),
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
