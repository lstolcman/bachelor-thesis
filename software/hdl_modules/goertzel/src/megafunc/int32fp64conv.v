...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" OPERATION="INT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=11 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=52 WIDTH_RESULT=64 aclr clock dataa result
...
module  int32fp64conv_altbarrel_shift_tvf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //int32fp64conv_altbarrel_shift_tvf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int32fp64conv_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //int32fp64conv_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int32fp64conv_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //int32fp64conv_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int32fp64conv_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	int32fp64conv_altpriority_encoder_3v7   altpriority_encoder12
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder12_q));
	int32fp64conv_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[3:2]),
...
endmodule //int32fp64conv_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int32fp64conv_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	int32fp64conv_altpriority_encoder_3e8   altpriority_encoder14
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder14_q),
	.zero(wire_altpriority_encoder14_zero));
	int32fp64conv_altpriority_encoder_3e8   altpriority_encoder15
	( 
	.data(data[3:2]),
...
endmodule //int32fp64conv_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int32fp64conv_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	int32fp64conv_altpriority_encoder_6v7   altpriority_encoder10
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder10_q));
	int32fp64conv_altpriority_encoder_6e8   altpriority_encoder11
	( 
	.data(data[7:4]),
...
endmodule //int32fp64conv_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int32fp64conv_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	int32fp64conv_altpriority_encoder_6e8   altpriority_encoder16
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder16_q),
	.zero(wire_altpriority_encoder16_zero));
	int32fp64conv_altpriority_encoder_6e8   altpriority_encoder17
	( 
	.data(data[7:4]),
...
endmodule //int32fp64conv_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int32fp64conv_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	int32fp64conv_altpriority_encoder_bv7   altpriority_encoder8
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder8_q));
	int32fp64conv_altpriority_encoder_be8   altpriority_encoder9
	( 
	.data(data[15:8]),
...
endmodule //int32fp64conv_altpriority_encoder_r08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int32fp64conv_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	int32fp64conv_altpriority_encoder_be8   altpriority_encoder18
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder18_q),
	.zero(wire_altpriority_encoder18_zero));
	int32fp64conv_altpriority_encoder_be8   altpriority_encoder19
	( 
	.data(data[15:8]),
...
endmodule //int32fp64conv_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int32fp64conv_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	int32fp64conv_altpriority_encoder_r08   altpriority_encoder6
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder6_q));
	int32fp64conv_altpriority_encoder_rf8   altpriority_encoder7
	( 
	.data(data[31:16]),
...
endmodule //int32fp64conv_altpriority_encoder_qb6

//synthesis_resources = lpm_add_sub 2 lpm_compare 1 reg 290 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int32fp64conv_altfp_convert_8hn
	( 
	aclr,
	clock,
	dataa,
...
`endif
	...
	int32fp64conv_altbarrel_shift_tvf   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	int32fp64conv_altpriority_encoder_qb6   altpriority_encoder2
	( 
	.data(prio_mag_int_a),
...
endmodule //int32fp64conv_altfp_convert_8hn
//VALID FILE
...
module int32fp64conv (
	...
	int32fp64conv_altfp_convert_8hn	int32fp64conv_altfp_convert_8hn_component (
				.aclr (aclr),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
