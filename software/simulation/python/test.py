...
plt.margins(0.05)
plt.grid()
plt.plot(np.sin(2*np.pi*.5*np.arange(0,2,1.0/10)))

plt.subplot(6,1,2)
plt.margins(0.05)
plt.grid()
plt.plot(abs(np.fft.fft(np.sin(2*np.pi*.5*np.arange(0,2,1.0/10)))))
...
taps = scipy.signal.firwin(fs, .2, window='hamming', pass_zero=True)
