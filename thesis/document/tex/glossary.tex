...
\newglossaryentry{usrp}{name={USRP}, description={(\textit{ang. Universal Software Radio Peripheral}) --- seria urządzeń \gls{sdr} zaprojektowanych przez firmę \href{https://www.ettus.com/}{Ettus Research}}}
...
\newglossaryentry{bcd}{name={BCD}, description={(\textit{ang. Binary-Coded Decimal}) --- system zapisu kolejnych cyfr liczby przy użyciu 4 młodszych bitów w reprezentacji dwójkowej tych cyfr}}
